...
<head> 
<title> JavaScript Count-Up Timers/Counters Demo - Praveen Lobo</title> 
<meta name="description" content="A demo page to show the Javascript Count-Up Timers by Praveen Lobo" /> 
<meta name="keywords" content="countup, countdown, timer, counter, count up, count down, years, months, days, hours, seconds, minutes, JavaScript, demo" /> 
<link rel="shortcut icon" href="http://www.praveenlobo.com/favicon.ico" /> 
 
<meta property="og:title" content="JavaScript Count-Up Timers Demo - Praveen Lobo" /> 
<meta property="og:type" content="website" /> 
<meta property="og:site_name" content="Praveen Lobo&#039;s website" /> 
<meta property="fb:admins" content="1485151061" /> 
<meta property="og:url" content="http://praveenlobo.com/techblog/javascript-countup-timer/"/> 
...
window.onload=function(){  
	new CountUnits('November 11, 2011 11:11:11', 'counter1');
	new CountUnits('June 23, 2010 19:15:00', 'counter2');
	new DayCounter('June 23, 2010 19:15:00', 'pastDayCounterLeft');
	new DayCounterFraction('November 11, 2011 11:11:11', 'pastDayCounterRight');
	new DaysHMSCounter('January 01, 2012 00:00:00', 'DHMSCounter');
	new CountDown('January 01, 2013 00:00:00', 'header', "COUNT DOWN to 2013.");
	new CountUp('January 01, 2011 00:00:00', 'footer', "COUNT UP since beginning of 2011.");
	new Counter(((new Date()).getTime()+10000), 'countdownup');
}

</script> 
<style> 
	html,body { margin: 0; padding: 0;}
	div {cursor: hand;text-align:center;}
	#header{font-size:15px;width:100%;height:25px;line-height:25px;background:white;border-bottom:1px solid black;top:0;position:absolute;}
	#content{top:25%;left:25%;position:absolute;width:50%;height:35%;overflow:auto;line-height:25px;border:1px solid black;}
	#counter1{width:50%;height:85%;float:left;background:black;color:white;}
	#counter2{width:50%;height:85%;float:right;}
	#footer{bottom:0;position:absolute;width:100%;height:30px;line-height:28px;background:black;font-size:15px;color:white;}
        #pastDayCounterLeft{top:20%;left:10%;position:absolute;width:10%;}
        #pastDayCounterRight{top:20%;left:80%;position:absolute;width:10%;}
        #DHMSCounter{top:65%;left:10%;position:absolute;}
        #countdownup{top:65%;left:60%;position:absolute;color:red;}
	#sharebox{bottom:15%;position:absolute;background:transparent;left:50px;}
</style> 
<script type="text/javascript"> 
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-20788457-2']);
...
<body> 
<div id="header"></div> 
<div id="pastDayCounterLeft"></div>
<div id="pastDayCounterRight"></div> 
<div id="DHMSCounter"></div>
<div id="countdownup"></div>
<div id="content"> 
	<div id="counter1"></div> 
	<div id="counter2"></div>
	<a href="http://PraveenLobo.com/techblog/javascript-countup-timer/" rel="follow">Go Back to Blog Post</a>
</div>
<div id="footer"></div> 
 
<div id="sharebox">
	<a href="http://twitter.com/share" class="twitter-share-button" data-count="vertical" data-via="lobopraveen">Tweet</a>
	<script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script>
	<script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like href="http://praveenlobo.com/techblog/javascript-countup-timer/" layout="box_count" show_faces="false" width="50px"></fb:like>
