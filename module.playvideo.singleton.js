        ...
        return {
                ...
                try {
                    if (typeof (ytplayer) == "undefined") {
                        ...
                        thumbs.each(function (i, value) {
                            ...
                            if (i > 1) {
                                if (jQuery(this).hasClass("hover") && s6) { playvideo.getInstance().hideYouTubeVideo(); }
                            }
                            if (i == 1) {
                                if (jQuery(this).hasClass("hover") && t > 0) { playvideo.getInstance().getVideoAgain(); }
                            }
                        });
                    }
                } catch (e) { }
            ...
            getVideoAgain: function () {
                try {
                    ...
                    if (s2 && (i == 2)) { playvideo.getInstance().showYouTubeVideo(); }
                } catch (e) { }
            },
