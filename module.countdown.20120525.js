                ...
                jQuery(counterId).each(function () {
                    ...
                    if (i == jQuery(this).attr("id")) {
                        ...
                        if (this.clock == "white" && this.clockdata == "hasAnimated") {
                        	this.clockwhite = '<img id="whiteclock" data-Animate="hasAnimated" src="static_clock.gif" />';
                        } else {
                            this.clockwhite = '<img id="whiteclock" src="animated_clock.gif" />';
                        }
                        if (this.clock == "gray" && this.clockdata == "hasAnimated") {
                        	this.clockgray = '<img id="grayclock" data-Animate="hasAnimated" src="gray_clock.png" />';
                        } else {
                            this.clockgray = '<img id="grayclock" src="animated_clock_gray.gif" />';
                        }
                        if (this.timeLeft > 0) {
