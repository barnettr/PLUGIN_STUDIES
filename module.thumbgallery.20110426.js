            ...
            var callInlineImage = function (i, s, bool) {
                if (bool) {
                    ...
                    switch (parseInt(allslides)) {
                        case 3: var e = slides.eq(i - 2); break;  // change these variables if number of slides change
                        case 4: var e = slides.eq(i - 1); break;  // change these variables if number of slides change
                    }
